...
namespace Stratosoft.File.IO
{
    ...
    /// </summary>
    public sealed class DelimitedValueParser : Parser
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DelimitedValueParser"/> class.
        /// </summary>
        ...
        public DelimitedValueParser(string filename, string delimiter, string textDelimiter)
            : base(filename)
        {
        ...
        public DelimitedValueParser(string filename, char delimiter, char textDelimiter)
        ...
        /// <param name="filename">The  path to the file containing the delimited data.</param>
        /// <param name="delimiter">A <see cref="string"/> specifying the delimiter used to separate the data.</param>
        public DelimitedValueParser(string filename, string delimiter)
        ...
        /// <param name="filename">The  path to the file containing the delimited data.</param>
        /// <param name="delimiter">A <see cref="char"/> specifying the delimiter used to separate the data.</param>
        public DelimitedValueParser(string filename, char delimiter)
