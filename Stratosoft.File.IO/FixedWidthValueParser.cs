...
namespace Stratosoft.File.IO
{
    ...
    /// </summary>
    public sealed class FixedWidthValueParser : Parser
    {
        private readonly int[] fieldWidths; // An array containing the widths of the fields.

        /// <summary>
        /// Initialises a new instance of the <see cref="FixedWidthValueParser"/> class.
        /// </summary>
        ...
        public FixedWidthValueParser(string filename, int[] fieldWidths)
            : base(filename)
        { 
