...
namespace StarLab.Data.Import
{
    ...
    /// </summary>
    internal class CompoundDataField : DataField
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="CompoundDataField"/> class.
        /// </summary>
        /// <param name="fieldDefinition">An <see cref="IFieldDefinition"/> that configures the <see cref="CompoundDataField"/>.</param>
        /// <param name="parser">An <see cref="IFileParser"/> that will be used to read data from a file.</param>
        public CompoundDataField(ICompoundFieldDefinition fieldDefinition, IFileParser parser)
