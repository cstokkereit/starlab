...
namespace StarLab.Application
{
    ...
    public interface IUseCaseFactory
    {
        ...
        IRenameDocumentUseCase CreateRenameDocumentUseCase(IWorkspaceOutputPort outputPort);

        IRenameDocumentUseCase CreateRenameFolderUseCase(IWorkspaceOutputPort outputPort);
