...
namespace StarLab.Data.MongoDB
{
    ...
    public class DatabaseTests
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="DatabaseTests"/> class.
        /// </summary>
        ...
        public void TearDown()
        {
            ...
            // Fix the HR diagram generation code
            // Fix the Projection stuff
            // Ultimately tie it to the Nomenclature stuff
        ...
        public void TestGetFirstTwentyStars()
        {
            ...
            var stars = database.GetStars(query, 0, 20);
        ...
        /// <summary>
        /// Test that the <see cref="DatabaseManager.GetStars(IQuery, int, int)"/> method correctly returns the specified stars.
        /// </summary>
        [Test]
        public void TestGetTwentyStars()
        {
            var database = manager.GetDatabase(DATABASE);
            ...
            var stars = database.GetStars(query, 800, 20);
        ...
        /// <summary>
        /// Test that the <see cref="DatabaseManager.GetStars(IQuery)"/> method correctly.
        /// </summary>
        [Test]
