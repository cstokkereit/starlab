...
namespace StarLab.UI
{
    ...
    {
        private readonly Presentation.Configuration.IConfigurationProvider configuration; // A service that provides the configuration information.
        ...
        /// <param name="configuration">The <see cref="AutoMapper.IConfigurationProvider"/> that will be used to get configuration information.</param>
        /// <param name="mapper">An <see cref="IMapper"/> that will be used to map model objects to data transfer objects and vice versa.</param>
        /// <param name="events">The <see cref="IEventAggregator"/> that manages application events.</param>
        public ViewFactory(IPresenterFactory factory, Presentation.Configuration.IConfigurationProvider configuration)
        {
