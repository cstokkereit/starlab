...
namespace StarLab.UI
{
    ...
    public partial class DockableView : DockContent, IDockableView
    {
        ...
        public DockableView(IViewContext context, IControlView content, IPresenterFactory presenterFactory)
        {
            InitializeComponent();
            ...
            presenter = presenterFactory.CreatePresenter(content, this);
