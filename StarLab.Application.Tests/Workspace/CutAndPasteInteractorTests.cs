...
{
    /// <summary>
    /// A class for performing unit tests on the <see cref="CutAndPasteInteractor"/> class.
    /// </summary>
    public class CutAndPasteInteractorTests : ApplicationTests
    {
        /// <summary>
        ...
        /// <summary>
        /// Test that the <see cref="CutAndPasteInteractor.Execute"/> method throws an exception when an existing document with the same name already exists.
        /// </summary>
        [Test]
        public void TestCutAndPasteADocumentThrowsExceptionWhenADocumentWithTheSameNameAlreadyExists()
        {
            var port = Substitute.For<IWorkspaceOutputPort>();
            ...
            Assert.Throws<DocumentExistsException>(() => interactor.Execute(new ClipboardUseCaseArgs(workspace, "B997452E-AC89-40B5-B304-525F93CCC0A1", "Workspace/Project1/Folder2")));

            port.DidNotReceive().UpdateWorkspace(Arg.Any<WorkspaceDTO>());
        }

        /// <summary>
        /// Test that the <see cref="CutAndPasteInteractor.Execute"/> method throws an exception when pasting a cut document to the same location within the workspace hierarchy as the original.
        /// </summary>
        [Test]
        public void TestCutAndPasteADocumentThrowsExceptionWhenSourceAndDestinationAreSameFolder()
        {
            var port = Substitute.For<IWorkspaceOutputPort>();
            ...
            Assert.Throws<DocumentExistsException>(() => interactor.Execute(new ClipboardUseCaseArgs(workspace, "B997452E-AC89-40B5-B304-525F93CCC0A1", "Workspace/Project1/Folder1")));
        ...
        /// <summary>
        /// Test that the <see cref="CutAndPasteInteractor.Execute"/> method throws an exception when an existing folder with the same name already exists.
        /// </summary>
        [Test]
        public void TestCutAndPasteAFolderThrowsExceptionWhenAFolderWithTheSameNameAlreadyExists()
        {
            var port = Substitute.For<IWorkspaceOutputPort>();
            ...
            Assert.Throws<Exception>(() => interactor.Execute(new ClipboardUseCaseArgs(workspace, "Workspace/Project1/Folder1/Folder3", "Workspace/Project1/Folder3")));
        ...
        /// </summary>
        [Test]
        public void TestCutAndPasteAFolderThrowsExceptionWhenSourceAndDestinationAreTheSameFolder()
        {
            var port = Substitute.For<IWorkspaceOutputPort>();
            ...
            Assert.Throws<FolderExistsException>(() => interactor.Execute(new ClipboardUseCaseArgs(workspace, "Workspace/Project1/Folder1/Folder3", "Workspace/Project1/Folder2")));
