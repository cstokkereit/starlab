...
{
    /// <summary>
    /// A mock class used for testing the classes derived from <see cref="CommandInvoker&lt;TComponent&gt;"/> as well as the <see cref="CommandChain"/> and <see cref="CommandManager"/> classes. 
    /// </summary>
