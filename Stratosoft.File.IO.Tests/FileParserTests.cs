...
{
    /// <summary>
    /// A class for performing unit tests on the <see cref="FileParser"/> class.
    /// </summary>
    public class FileParserTests
    {
        ...
        /// <summary>
        /// Initialises a new instance of the <see cref="FileParserTests"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Test that the <see cref="FileParser(DelimitedValueParser, Dictionary{string, int})"/> constructor works correctly.
        /// </summary>
        [Test]
        public void TestConstructorWithFileParserAndFieldMap()
        {
            var parser = new FileParser(new DelimitedValueParser(Path.Combine(resources, "Csv.txt"), ","), map);

            Assert.That(parser, Is.Not.Null);
        }

        /// <summary>
        /// Test that the <see cref="FileParser(DelimitedValueParser)"/> constructor works correctly.
        /// </summary>
        [Test]
        public void TestConstructorWithFileParser()
        {
            var parser = new FileParser(new DelimitedValueParser(Path.Combine(resources, "Csv.txt"), ","));

            Assert.That(parser, Is.Not.Null);
        }

        /// <summary>
        /// Test that the <see cref="FileParser.GetValue(int)"/> method throws an exception if the end of the file has been reached.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="FileParser.GetValue(int)"/> method returns the value of the field with the index.
        /// </summary>
        [Test]
        public void TestGetValueByIndex()
        {
            ...
            Assert.That(parser.GetValue(1), Is.EqualTo("Value-1.1"));
            Assert.That(parser.GetValue(2), Is.EqualTo("Value-1.2"));
            Assert.That(parser.GetValue(3), Is.EqualTo("Value-1.3"));
        }

        /// <summary>
        /// Test that the <see cref="FileParser.GetValue(string)"/> method throws an exception if the field map has not been set.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="FileParser.GetValue(string)"/> method throws an exception if the end of the file has been reached.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="FileParser.GetValue(string)"/> method returns the value of the field with the specified name.
        /// </summary>
        [Test]
        public void TestGetValueByName()
        {
            ...
            Assert.That(parser.GetValue("F2"), Is.EqualTo("Value-1.1"));
            Assert.That(parser.GetValue("F3"), Is.EqualTo("Value-1.2"));
            Assert.That(parser.GetValue("F4"), Is.EqualTo("Value-1.3"));
        }

        /// <summary>
        /// Test that the <see cref="FileParser.Parse()"/> method works correctly with a comma delimited file and mapped field names.
        /// </summary>
        [Test]
        ...
        {
            var parser = new FileParser(new DelimitedValueParser(Path.Combine(resources, "Empty.txt"), ","), map);
