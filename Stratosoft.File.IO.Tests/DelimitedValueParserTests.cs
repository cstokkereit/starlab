...
{
    /// <summary>
    /// A class for performing unit tests on the <see cref="DelimitedValueParser"/> class.
    /// </summary>
    public class DelimitedValueParserTests : ParserTests
    {
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser(string, char, char)"/> constructor works correctly.
        /// </summary>
        [Test]
        public void TestConstructorWithFileNameCharDelimiterAndCharTextDelimiter()
        {
            var parser = new DelimitedValueParser(Path.Combine(resources, "Csv.txt"), ',', '\"');

            Assert.That(parser, Is.Not.Null);
        }

        /// <summary>
        /// Test that the <see cref="DelimitedValueParser(string, string, string)"/> constructor works correctly.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser(string, char)"/> constructor works correctly.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser(string, string)"/> constructor works correctly.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse()"/> method works correctly with a comma delimited file.
        /// </summary>
        [Test]
        public void TestParseCsv()
        {
            using (var parser = new DelimitedValueParser(Path.Combine(resources, "Csv.txt"), ','))
            {
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse()"/> method works correctly with a file that uses two pipes as the delimiter.
        /// </summary>
        [Test]
        public void TestParsePipes()
        {
            using (var parser = new DelimitedValueParser(Path.Combine(resources, "Pipes.txt"), "||"))
            {
                string[] data = parser.Parse();
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse()"/> method works correctly with a tab delimited file.
        /// </summary>
        [Test]
        public void TestParseTab()
        {
            using (var parser = new DelimitedValueParser(Path.Combine(resources, "Tab.txt"), '\t'))
            {
                string[] data = parser.Parse();
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse()"/> method works correctly with a space delimited text file that uses single quotes to enclose text values.
        /// </summary>
        [Test]
        public void TestParseSingleQuotedText()
        {
            using (var parser = new DelimitedValueParser(Path.Combine(resources, "Text1.txt"), " ", "'"))
            {
                string[] data = parser.Parse();
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse()"/> method works correctly with a space delimited text file that uses double quotes to enclose text values.
        /// </summary>
        [Test]
        public void TestParseDoubleQuotedText()
        {
            using (var parser = new DelimitedValueParser(Path.Combine(resources, "Text2.txt"), ' ', '\"'))
            {
                string[] data = parser.Parse();
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse(int)"/> method works correctly with a comma delimited file.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse(int)"/> method works correctly with a tab delimited file.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse(int)"/> method works correctly with a space delimited text file that uses single quotes to enclose text values.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.Parse(int)"/> method works correctly with a comma delimited file when there are fewer unparsed lines remaining than specified.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.ParseAll()"/> method works correctly with a comma delimited file.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test that the <see cref="DelimitedValueParser.ParseAll()"/> method works correctly with a comma delimited text file that uses single quotes to enclose text values.
        /// </summary>
        [Test]
