namespace StarLab.Shared.Resources
{
    ...
    {
        public const string ActiveViewChanged = "The active view has changed from {0} to {1}.";

        public const string Initialised = "The {0} has been initialised.";

        public const string PresenterAttached = "The {0} has been attached.";

        public const string PresenterDetached = "The {0} has been detached.";
