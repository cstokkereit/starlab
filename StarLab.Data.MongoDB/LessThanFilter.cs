...
{
    /// <summary>
    /// A MongoDB specific implementation of the <see cref="IPredicate"/> interface that only retrieves those documents for which the contents of the specified field are less than the comparison value.
    /// </summary>
    /// <typeparam name="T">The type of the comparison value.</typeparam>
    internal class LessThanFilter<T> : BinaryPredicate<T>, IFilterAdapter
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="LessThanFilter{T}"/> class.
        /// </summary>
        /// <param name="field">TODO</param>
        /// <param name="value">The comparison value.</param>
        public LessThanFilter(IField field, T value)
            : base(field, value) { }
        ...
        public FilterDefinition<BsonDocument> GetFilter()
        {
            ...
            {
                return Builders<BsonDocument>.Filter.Lt(lhs.Name, rhs.Value);
            }
        ...
        /// <summary>
        /// Converts the value of the current <see cref="LessThanFilter{T}"/> object to its equivalent string representation.
        /// </summary>
        ...
        /// <returns>A string representation of the current <see cref="LessThanFilter{T}"/> object.</returns>
