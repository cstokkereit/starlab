...
namespace Stratosoft.Commands
{
    ...
    public abstract class CommandInvoker<TComponent> : ICommandInvoker
    {
        ...
        private void Validate(Component component)
        {
            ...
            if (typeof(TComponent) != component.GetType()) throw new ArgumentException(string.Format(Resources.InvalidComponentType, typeof(TComponent), component.GetType()));  // TODO - Use ExceptionMessages
        }
    }
}
