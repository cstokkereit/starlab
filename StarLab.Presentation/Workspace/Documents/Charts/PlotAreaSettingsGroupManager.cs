...
{
    /// <summary>
    /// Displays the settings sections applicable to the plot area settings group.
    /// </summary>
    internal class PlotAreaSettingsGroupManager : SettingsGroupManager<IChartSettingsView>
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="PlotAreaSettingsGroupManager"/> class.
        /// </summary>
        ...
        public PlotAreaSettingsGroupManager(IChartSettingsView view, string group)
            : base(view, group) { }
