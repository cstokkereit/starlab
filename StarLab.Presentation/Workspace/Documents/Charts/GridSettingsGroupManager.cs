...
{
    /// <summary>
    /// Displays the settings sections applicable to the grid settings group.
    /// </summary>
    internal class GridSettingsGroupManager : SettingsGroupManager<IChartSettingsView>
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="GridSettingsGroupManager"/> class.
        /// </summary>
        ...
        public GridSettingsGroupManager(IChartSettingsView view, string group)
            : base(view, group) { }
