...
{
    internal class PointsSettingsGroupManager : SettingsGroupManager<IChartSettingsView>
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="PointsSettingsGroupManager"/> class.
        /// </summary>
        ...
        public PointsSettingsGroupManager(IChartSettingsView view, string group)
            : base(view, group) { }
        ...
        public override void ShowSettings(IChartSettings settings)
        {
            ...
            View.AppendSizeSection(settings, Group);
