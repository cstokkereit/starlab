namespace StarLab.Presentation.Workspace.Documents.Charts
{
    ...
    /// </summary>
    internal class LabelSettingsGroupManager : SettingsGroupManager<IChartSettingsView>
    {
        /// <summary>
        ...
        public LabelSettingsGroupManager(IChartSettingsView view, string group)
            : base(view, group) { }
        ...
        {
            View.AppendTextSection(settings, Group);
