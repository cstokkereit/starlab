...
{
    /// <summary>
    /// Displays the settings sections applicable to the grid line settings group.
    /// </summary>
    internal class GridLineSettingsGroupManager : SettingsGroupManager<IChartSettingsView>
    {
        /// <summary>
        /// Initialises a new instance of the <see cref="GridLineSettingsGroupManager"/> class.
        /// </summary>
        ...
        public GridLineSettingsGroupManager(IChartSettingsView view, string group)
            : base(view, group) { }
