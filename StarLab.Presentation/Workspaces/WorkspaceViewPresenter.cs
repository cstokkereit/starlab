...
namespace StarLab.Presentation.Workspaces
{
    internal class WorkspaceViewPresenter : FormViewPresenter<IWorkspaceView>, IWorkspaceViewPresenter, IWorkspaceController, IWorkspaceOutputPort
    {
        ...
        public IDockableView CreateView(string name)
        {
            if (factory == null) throw new InvalidOperationException(StringResources.MessageNotInitialised);

            IDockableView view;

            if (workspace.HasDocument(name))
            {
                view = factory.CreateView(workspace.GetDocument(name));
            }
            else
            {
        ...
        public override void Initialise(IApplicationController controller)
        {
            ...
            CreateViewMenu(controller);
            CreateWorkspaceMenu(controller);
            CreateToolsMenu(controller);
            CreateWindowMenu(controller);
            CreateHelpMenu(controller);

            CreateStandardToolbar(controller);
        }

        public void SetActiveDocument(string name)
        {
            workspace.SetActiveDocument(name);
        ...
        public void SaveWorkspace()
        {
            ...
            var interactor = UseCaseFactory.CreateSaveWorkspaceUseCase();
        ...
        /// </summary>
        private void CreateFileMenu(IApplicationController controller)
        {
            ...
            View.AddMenuItem(Constants.FILE_OPEN, Constants.FILE_OPEN_WORKSPACE, StringResources.Workspace + Constants.ELLIPSIS, ImageResources.OpenWorkspace, controller.GetCommand(CreateAction<IWorkspaceController>(this, Verbs.OPEN)));
            View.AddMenuSeparator(Constants.FILE);
            View.AddMenuItem(Constants.FILE, Constants.FILE_CLOSE, StringResources.Close); //, commands.GetCommand(Constants.FILE_CLOSE));
            View.AddMenuItem(Constants.FILE, Constants.FILE_CLOSE_WORKSPACE, StringResources.CloseWorkspace, ImageResources.CloseWorkspace, controller.GetCommand(CreateAction<IWorkspaceController>(this, Verbs.CLOSE)));
            View.AddMenuSeparator(Constants.FILE);
            View.AddMenuItem(Constants.FILE, Constants.FILE_SAVE_ALL, StringResources.SaveAll, ImageResources.SaveAll, controller.GetCommand(CreateAction<IWorkspaceController>(this, Verbs.SAVE)));
            View.AddMenuSeparator(Constants.FILE);
            View.AddMenuItem(Constants.FILE, Constants.FILE_PAGE_SETUP, StringResources.PageSetup + Constants.ELLIPSIS, ImageResources.PageSetup); //, controller.GetCommand(this, Constants.FILE_PAGE_SETUP));
            View.AddMenuItem(Constants.FILE, Constants.FILE_PRINT, StringResources.Print + Constants.ELLIPSIS, ImageResources.Print); //, controller.GetCommand(this, Constants.FILE_PRINT));
            View.AddMenuSeparator(Constants.FILE);
            View.AddMenuItem(Constants.FILE, Constants.FILE_EXIT, StringResources.Exit); //, controller.GetCommand(this, Constants.FILE_EXIT));
        }

        /// <summary>
        /// Creates the help menu.
        /// </summary>
        private void CreateHelpMenu(IApplicationController controller)
        {
            View.AddMenuItem(Constants.HELP, StringResources.Help);
            //View.AddMenuItem(Constants.HELP, Constants.HELP_VIEW_HELP, Resources.ViewHelp, controller.GetCommand(this, Constants.VIEW_HELP));
            View.AddMenuSeparator(Constants.HELP);
            View.AddMenuItem(Constants.HELP, Constants.HELP_ABOUT, StringResources.AboutStarLab, controller.GetCommand(CreateAction<IViewController>(this, Verbs.SHOW, Views.ABOUT)));
        }

        /// <summary>
        /// TODO
        /// </summary>
        private void CreateStandardToolbar(IApplicationController controller)
        {
            View.AddToolbarButton(Constants.FILE_OPEN_WORKSPACE, StringResources.OpenWorkspace, ImageResources.OpenWorkspace, controller.GetCommand(CreateAction<IWorkspaceController>(this, Verbs.OPEN)));
            View.AddToolbarButton(Constants.FILE_SAVE_ALL, StringResources.SaveAll, ImageResources.SaveAll, controller.GetCommand(CreateAction<IWorkspaceController>(this, Verbs.SAVE)));
        }

        /// <summary>
        /// Creates the tools menu.
        /// </summary>
        private void CreateToolsMenu(IApplicationController controller)
        {
            View.AddMenuItem(Constants.TOOLS, StringResources.Tools);
            View.AddMenuItem(Constants.TOOLS, Constants.TOOLS_OPTIONS, StringResources.Options, ImageResources.Settings, controller.GetCommand(CreateAction<IViewController>(this, Verbs.SHOW, Views.OPTIONS)));
        }

        /// <summary>
        /// Creates the view menu.
        /// </summary>
        private void CreateViewMenu(IApplicationController controller)
        {
            View.AddMenuItem(Constants.VIEW, StringResources.View);
            View.AddMenuItem(Constants.VIEW, Constants.VIEW_WORKSPACE_EXPLORER, StringResources.WorkspaceExplorer, controller.GetCommand(CreateAction<IViewController>(this, Verbs.SHOW, Views.WORKSPACE_EXPLORER)));
        }

        /// <summary>
        /// Creates the window menu.
        /// </summary>
        private void CreateWindowMenu(IApplicationController controller)
        {
            View.AddMenuItem(Constants.WINDOW, StringResources.Window);
        }

        private void CreateWorkspaceMenu(IApplicationController controller)
        {
