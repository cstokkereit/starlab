...
{
    internal class WorkspaceExplorerViewPresenter : ControlViewPresenter<IWorkspaceExplorerView, IViewController>, IWorkspaceExplorerViewPresenter, IWorkspaceExplorerController, ISubscriber<ActiveDocumentChangedEvent>, ISubscriber<WorkspaceChangedEvent>
    {
        ...
        public override void Initialise(IApplicationController controller, IViewController parentController)
        {
