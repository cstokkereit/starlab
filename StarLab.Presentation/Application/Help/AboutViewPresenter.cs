...
namespace StarLab.Application.Help
{
    ...
    internal class AboutViewPresenter : ChildViewPresenter<IAboutView, IDialogController>, IAboutViewPresenter, IChildViewController
    {
        ...
        public AboutViewPresenter(IAboutView view, ICommandManager commands, IUseCaseFactory factory, IConfigurationService configuration, IMapper mapper, IEventAggregator events)
